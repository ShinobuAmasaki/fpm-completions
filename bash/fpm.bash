...
build_dir_analysis() {
	...
	local -a executables=($(find $(find "$build_dir" -type d -name app) -type f -executable))
...
build_dir_analysis_test() {
	...
	local -a tests=($(find $(find "$build_dir" -type d -name test) -type f -executable))
...
build_dir_analysis_example() {
	...
	local -a expls=($(find $(find "$build_dir" -type d -name example) -type f -executable))
